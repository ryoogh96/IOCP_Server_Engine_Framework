...
def main():
    ...
    arg_parser.add_argument('--path', type=str, default='D:/Cpp_IOCP/Cpp_IOCP_Server/Main/DB/GameDB.xml', help='Xml Path')
    arg_parser.add_argument('--output', type=str, default='GenProcedures.hpp', help='Output File')
    ...
    template = env.get_template('GenProcedures.hpp')
